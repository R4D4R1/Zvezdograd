...
public class ResourceController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject notificationPrefab; // œÂÙ‡· Û‚Â‰ÓÏÎÂÌËˇ
    [SerializeField] private Transform notificationParent; // –Ó‰ËÚÂÎ¸ ‰Îˇ Û‚Â‰ÓÏÎÂÌËÈ
    ...
    public void AddOrRemoveProvision(int value) => ModifyResource(ref provision, value, maxProvision, provisionSlider, provisionText, "œ–Œ¬»«»ﬂ");
    public void AddOrRemoveMedicine(int value) => ModifyResource(ref medicine, value, maxMedicine, medicineSlider, medicineText, "Ã≈ƒ» ¿Ã≈Õ“€");
    public void AddOrRemoveRawMaterials(int value) => ModifyResource(ref rawMaterials, value, maxRawMaterials, rawMaterialsSlider, rawMaterialsText, "—€–‹≈");
    public void AddOrRemoveReadyMaterials(int value) => ModifyResource(ref readyMaterials, value, maxReadyMaterials, readyMaterialsSlider, readyMaterialsText, "—“–Œ…Ã¿“≈–»¿À€");
    public void AddOrRemoveStability(int value) => ModifyResource(ref stability, value, maxStability, stabilitySlider, stabilityText, "—“¿¡»À‹ÕŒ—“‹", true);
    ...
    private void ModifyResource(ref int resource, int value, int maxValue, Slider slider, TextMeshProUGUI text, string label, bool isStability = false)
    {
        ...
        {
            string operation = value > 0 ? "ƒÓ·‡‚ÎÂÌÓ" : "”·‡‚ÎÂÌÓ";
