...
public class TutorialControllerConfig : ScriptableObject
{
    ...
    [SerializeField, TextArea(2, 5)] private string collectableBuildingDescription;
    [SerializeField, TextArea(2, 5)] private string intactBuildingDescription;
    [SerializeField, TextArea(2, 5)] private string factoryBuildingDescription;
    [SerializeField, TextArea(2, 5)] private string cityHallBuildingDescription;
    [SerializeField, TextArea(2, 5)] private string hospitalBuildingDescription;
    [SerializeField, TextArea(2, 5)] private string foodTruckBuildingDescription;
    ...
    [SerializeField, TextArea(2, 5)] private string clockDescription;
    [SerializeField, TextArea(2, 5)] private string provisionDescription;
    [SerializeField, TextArea(2, 5)] private string medsDescription;
    [SerializeField, TextArea(2, 5)] private string rawMaterialsDescription;
    [SerializeField, TextArea(2, 5)] private string readyMaterialsDescription;
    [SerializeField, TextArea(2, 5)] private string unitsDescription;
    [SerializeField, TextArea(2, 5)] private string stabilityDescription;
    [SerializeField, TextArea(2, 5)] private string nextTurnDescription;
